...
<head>
    ...
    <title>Pro registrované 2</title>
...
<body>
        <div class="container">
        <h1 class="text-center mt-4">Pro registrované 2</h1>
        <?php menu(); 
        include_once 'modaly.php';
        include_once 'reg_prihl_odhl.php';
        if(!empty($_SESSION['uzivatel'])){ //pokud je neco v session klic uzivatel
            echo "<div class='text-center d-flex flex-column bg-light mb-5'>";
            echo "<h2>Tuto fotku vidí pouze přihlášení uživatelé:</h2>";
            echo "<img src='malídva.jpg'>";
            echo "</div>";
